          ...
          <div className={`${cardBg} p-8 rounded-2xl border ${borderColor} shadow-sm`}>
            <div className="flex items-center gap-3 mb-8">
              ...
              {userProfile?.role === 'AMBASSADOR' && (
                <span className="ml-auto px-2 py-0.5 bg-amber-100 text-amber-700 border border-amber-200 rounded-full text-[9px] font-bold uppercase tracking-wider flex items-center gap-1 shadow-sm">
