    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className={`absolute top-14 left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 w-[calc(100vw-32px)] sm:w-80 animate-in fade-in zoom-in-95 slide-in-from-top-4 duration-200 ${darkMode ? "bg-slate-950 border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)]" : "bg-white border-orange-100 shadow-xl"} border rounded-2xl z-50 overflow-hidden`}>
