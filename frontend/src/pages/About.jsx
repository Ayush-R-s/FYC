    ...
    return (
        <div className="min-h-[100dvh] bg-primary text-text-primary animate-fade-in p-8 lg:p-24">
            <section className="px-8 lg:px-24 py-12 max-w-6xl mx-auto text-center">
                <h1 className="text-5xl font-bold mb-10">About <span className="text-accent">Jest Exam</span></h1>
                <p className="text-xl text-text-secondary max-w-3xl mx-auto mb-16 leading-relaxed">
                    The National Eligibility cum Entrance Test (Jest) UG is India's single national-level medical entrance exam for admission to MBBS, BDS, and other undergraduate medical courses.
                </p>
                ...
                <div className="bg-primary border border-border-color p-10 rounded-3xl shadow-xl text-left mb-12">
                    <h2 className="text-3xl font-bold mb-6 text-text-primary flex items-center gap-3">
                        <BookOpen className="text-accent" /> Exam Overview (Jest UG 2026)
                    </h2>
                    <p className="text-text-secondary mb-10 text-lg">Conducted by the National Testing Agency (NTA), Jest is mandatory for aspiring medical students in government and private colleges across India. The exam is pen-and-paper based and held in a single shift.</p>
